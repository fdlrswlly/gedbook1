...
class RegisterActivity : AppCompatActivity() {
    ...
    lateinit var userDataHelper: DataHelper
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userDataHelper = DataHelper(this)
    ...
    fun registerme(view: View){
        ...
        var cekuser = userDataHelper.cekUser(iemail)
        var status = "Gagal"
        if (cekuser =="0") {
            userDataHelper.RegisterUser(iemail, ipassword, ifullname, ijenkal, ialamat)
            status = "Sukses"
